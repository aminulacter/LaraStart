                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane active" id="settings">
                    <form class="form-horizontal" @submit.prevent="updateInfo">
                      ...
                      <div class="form-group row">
                        <label for="profImage" class="col-sm-2 col-form-label">Profile Image</label>
                        <div class="col-sm-10">
                          <input type="file" class="form-control" id="profImage" name="photo" @change="updateProfile">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="passportname" class="col-sm-2 col-form-label">password (leave empty if not changing)</label>
                        <div class="col-sm-10">
                          <input type="password" class="form-control" id="passportname" placeholder="password"  :class="{ 'is-invalid': form.errors.has('password') }" v-model="form.password">
      ...
      data() {
       ...
       created() {
        ...
        computed: {
          profilePic()
          {
            return "img/profile/" +  this.profileImage
          }
        },
        methods: {
          updateProfile(e){
